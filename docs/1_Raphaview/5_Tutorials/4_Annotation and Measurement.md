...
영상의 측정과 관련된 기능들이 모여 있습니다. Measurments 항목을 선택하면 하위메뉴가 나타납니다. 자세한 내용은 본 장의 『Measurements(측정도구) 메뉴』의 내용을 참조하시기 바랍니다.
...
## Apply All
이미지 모드에서 선택된 영상뿐만 아니라 시리즈 내의 영상에도 변경내용을 적용할 것인지를 지정하는데 사용하는 토글기능입니다. 자세한 내용은 본 장의 『Apply All 메뉴』의 내용을 참조하시기 바랍니다.
...
## Length(길이 측정)
메뉴바의 [Length] 메뉴를 이용하여 영상의 원하는 부위의 길이를 직선을 이용하여 측정하는 메뉴입니다.


## Angle(각도측정)
메뉴바의 [Angle] 메뉴는 각도를 측정하기 원하는 부위에 2 개의 선을 표시하고 그 선들이 이루고 있는 각도를 측정하는 메뉴입니다.
