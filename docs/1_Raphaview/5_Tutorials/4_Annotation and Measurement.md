...
1. 메뉴바에서 [Annot.] 메뉴의 하위메뉴에서 [Line] 하위메뉴를 마우스로 선택합니다
마우스 커서가 로 변경되면서 Line 주석 기능을 사용할 수 있게 됩니다.
Line 주석을 그리기 위해서는 영상의 원하는 부분에 마우스를 클릭하여 시작점을 지정한
후 마우스를 원하는 곳까지 드래그 후 마우스 클릭을 해제하면 Line 이 그려집니다.
