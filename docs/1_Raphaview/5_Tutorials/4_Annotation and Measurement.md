...
영상에 가해진 조작기능(W/L, Zoom, Pan)이나 측정기능(Length, Angle, Trans, Measerments, Annot.)을 모두 초기화하여 영상을 처음 상태로 리셋하는 기능입니다.


**Reset: 영상 처음상태로 리셋하기**
Reset 기능은 영상에 가해진 조작기능(W/L, Zoom, Pan)이나 측정기능(Length, Angle, Trans, Measerments, Annot.)을 모두 초기화하여 영상을 처음 상태로 리셋하는 기능입니다.
